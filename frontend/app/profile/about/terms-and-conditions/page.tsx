    ...
    <main className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="fp-container py-6">
        <article className="prose prose-slate dark:prose-invert max-w-none text-sm text-slate-800 dark:text-slate-200">
          <p className="mb-4">
            We provide a level of security appropriate to the risk of processing your personal information. For more information on how FreightPOP protects your personal information please contact us.
          </p>
          ...
          <ul className="list-disc space-y-3 pl-5">
            ...
            <li>
              Similarly, if we have collected and process your personal information with your consent, then you can <strong>withdraw your consent at any time</strong>. Withdrawing your consent will not affect the lawfulness of any processing we conducted prior to your withdrawal, nor will it affect processing of your personal information conducted in reliance on lawful processing grounds other than consent.
            </li>
            <li>
              You may have the right to <strong>opt out of the sale</strong> of your personal information. FreightPOP does not sell your personal information to third parties for profit. However, we do share or otherwise disclose your personal information to third parties in accordance with this Privacy Statement and our{" "}
              <Link
            ...
            <li>
              You have the right to <strong>complain</strong> to a data protection authority responsible for overseeing compliance with data protection law in your jurisdiction. For example, individuals in the European Economic Area (EEA) have the right to lodge a complaint with the competent Data Protection Authority. A list of EEA data protection authorities is available at:{" "}
              <a
          ...
          <p className="mt-6">
            We would however appreciate the opportunity to address your concerns, so please feel free to contact us regarding any complaint you may have. We will not discriminate against you for exercising any of your privacy rights.
          </p>
        </article>
      </div>
    </main>
